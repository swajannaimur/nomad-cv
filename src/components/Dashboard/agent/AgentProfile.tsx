...
export default function AgentProfile({ id, data }: AgentProfileProps) {
  ...
  const agentEmail = email || 'No email provided';
  const agentPhone = phone || 'No phone provided';
  const agentCity = profile?.city || 'City not provided';
  const agentCountry = profile?.country || 'Country not provided';
  const agentCompany = profile?.company || 'Company not provided';
      ...
      <div className="w-full md:w-1/3 bg-gray-50 rounded-lg p-6 flex flex-col items-center">
        ...
        <div className="w-full">
          ...
          <div className="flex justify-between text-sm py-1">
            ...
            <span className="font-medium">{agentCity}</span>
          </div>
          <div className="flex justify-between text-sm py-1">
          ...
          <div className="flex justify-between text-sm py-1">
            ...
            <span className="font-medium">{agentCountry}</span>
          </div>
          <div className="flex justify-between text-sm py-1">
          ...
          <div className="flex justify-between text-sm py-1">
            ...
            <span className="font-medium">{agentEmail}</span>
          </div>
          <div className="flex justify-between text-sm py-1">
            <span className="text-gray-500">Phone Number</span>
            <span className="font-medium">{agentPhone}</span>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="border rounded-lg">
            <div className="grid grid-cols-2 text-sm">
              <div className="border-b px-4 py-2 text-gray-500">Agent Name</div>
              <div className="border-b px-4 py-2 font-medium">{agentName}</div>
              <div className="border-b px-4 py-2 text-gray-500">Agency</div>
              <div className="border-b px-4 py-2 font-medium">{agentCompany}</div>
              <div className="border-b px-4 py-2 text-gray-500">Agent License</div>
              ...
              <div className="px-4 py-2 text-gray-500">Agent City</div>
              <div className="px-4 py-2 font-medium">{agentCity}</div>
            </div>
          </div>
        </div>
