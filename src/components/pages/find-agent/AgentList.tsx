...
// import profesionImg from "@/assets/images/download.jpeg";
...
const MortgageList: React.FC = () => {
  ...
  // --- Local search filter ---
  const filteredMortgages = agents.filter(
    (m) =>
          ...
          {[...Array(6)].map((_, i) => (
            <Card key={i} className="animate-pulse">
              <CardContent className="p-6 flex">
                <div className="w-48 h-64 bg-gray-200 rounded-lg mr-6"></div>
  ...
  return (
    <>
      ...
      >
        <div className="absolute bottom-[-20%] md:bottom-[-10%] w-full">
          <div className="max-w-7xl mx-auto px-4">
            <Card className="w-full max-w-3xl mx-auto shadow-2xl border-0 p-4">
              <form
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-3 py-1 text-sm outline-none focus:ring focus:ring-blue-300 border rounded-lg 
                 md:flex-1 md:w-auto"
                />

                {/* Button - Full width on mobile, fixed size on desktop */}
                <Button
                  type="submit"
                  size="lg"
                  className="w-full md:w-32 h-[40px] text-[#171A2A] bg-[#E2C59F] hover:bg-[#B8A366] 
                 border-[#CBB677] hover:border-[#B8A366]"
                >
      ...
      <div className="text-center mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold ">Featured Agents</h1>
      </div>
